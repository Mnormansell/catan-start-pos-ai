...
class CatanSpectator(tkinter.Frame):
    ...
    def __init__(self, options=None, *args, **kwargs):
        ...
        self._setup_game_toolbar_frame = views.SetupGameToolbarFrame(self, self.game, options=options)
...
def main():
    ...
    parser.add_argument('--num_players', '-n', help='number of players 2', default=4)
